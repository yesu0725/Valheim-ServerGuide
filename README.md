...
| `dvergr_recruited` | Player frees a Dvergr — optional `caste` filter *(requires Lost Scrolls II)* |
| `dvergr_duel_won` | Player wins a Dvergr duel *(requires Lost Scrolls II)* |
| `dvergr_level_up` | A recruited Dvergr levels up *(requires Lost Scrolls II)* |
