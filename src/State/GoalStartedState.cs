...
{
    /// Persistent "started" flag for item_acquired multi-goal entries, stored via PlayerProgress
    /// (server-owned progress file) alongside SeenTracker / ChainState / SubmitState data.
    ...
    public static class GoalStartedState
    {
        ...
        public static void ResetAll(Player player)
        {
            ...
            PlayerProgress.RemoveWithPrefix(player, StartedPrefix);
        }
    }
}
